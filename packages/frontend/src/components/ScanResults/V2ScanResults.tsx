...
const V2ScanResults: React.FC<V2ScanResultsProps> = ({ scan }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {/* NEW: Highlights (Positive and Negative) */}
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          {expandedSections.has('scoring') && (
            <div className="mt-4 space-y-4">
              ...
              {/* Probability Breakdown - FIXED with null checks */}
                ...
                <div key={i} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
                      ...
                      {/* Show earned/possible points */}
                      {cat.earnedPoints !== undefined && cat.possiblePoints !== undefined && (
                        <div className="text-sm text-gray-600 mt-1">
                          Earned: {cat.earnedPoints}/{cat.possiblePoints} points ({cat.percentage || 0}%)
                        </div>
                      )}
                    </div>
                    <div className="ml-4 text-right">
