  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center p-4">
      <div className="bg-white shadow-2xl rounded-lg max-w-md w-full p-8">
        ...
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-2">Elara Platform</h1>
        <p className="text-center text-gray-600 mb-8">Enterprise Threat Detection</p>
