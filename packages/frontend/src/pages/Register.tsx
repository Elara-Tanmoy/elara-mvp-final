...
const Register: React.FC = () => {
  ...
  const handleSocialLogin = (provider: 'google' | 'facebook' | 'linkedin') => {
    ...
    const backendUrl = import.meta.env.VITE_API_BASE_URL || 'https://elara-backend.onrender.com';
    window.location.href = `${backendUrl}/v2/auth/${provider}`;
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center p-4">
      <div className="bg-white shadow-2xl rounded-lg max-w-md w-full p-8">
        ...
        <p className="text-center text-gray-600 mb-8">Join Elara Platform</p>

        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-3 flex items-center gap-2 text-red-700 mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-primary-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-primary-700 disabled:bg-gray-300"
          >
